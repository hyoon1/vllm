...
def kernel_unified_attention_2d(
    ...
    for j in range(tile_start, tile_end):
        ...
        # K : (HEAD_SIZE, TILE_SIZE) or (HEAD_SIZE, BLOCK_SIZE) when equal
        K_load = tl.load(
        ...
        # V : (TILE_SIZE, HEAD_SIZE) or (BLOCK_SIZE, HEAD_SIZE) when equal
        V_load = tl.load(
        ...
        # S : (BLOCK_M, TILE_SIZE) or (BLOCK_M, BLOCK_SIZE) when equal
        ...
        if USE_QQ_BIAS:
            ...
            key_rel_pos = seq_offset - context_len  # shape: [TILE_SIZE]
