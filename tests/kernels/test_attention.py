...
def test_paged_attention(
    ...
    if (version == "rocm" and is_navi() and
        (kv_cache_dtype == "fp8" or head_size != 128 or
         block_size != 16 or use_alibi)):
        pytest.skip()
        ...
        if version == "v2":
            ...
            opcheck(torch.ops._rocm_C.paged_attention,
                    (output, exp_sums, max_logits, tmp_output, query,
                     ...
                     kv_cache_dtype, k_scale, v_scale, None, PARTITION_SIZE, is_navi()),
                    cond=(head_size == HEAD_SIZES[0]
                          and block_size == BLOCK_SIZES[0]))
